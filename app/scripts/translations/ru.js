...
NAV_SendEther               : 'Перевести REOSC и токены ',
...
x_AddessDesc                : 'Your Address can also be known as you `Account #` or your `Public Key`. It is what you share with people so they can send you REOSC or Tokens. Find the colorful address icon. Make sure it matches your paper wallet & whenever you enter your address somewhere. Это можно назвать "номер Вашего счёта" или "Ваш открытый ключ". Вы сообщаете этот адрес людям, чтобы они могли отправлять Вам REOSC. Картинка позволяет легко опознать Ваш адрес среди других адресов. ',
x_Address                   : 'Ваш адрес ',
x_Cancel                    : 'Отменить ',
...
TRANSModal_Content_4        : '**Coinbase и ShapeShift: ** Отправляйте им только обычные транзакции. Если Вы отправите им транзакцию вида "только ...", то Вам придётся обращаться к их службе поддержки, чтобы они вручную пополнили Ваш баланс или вернули бы Вам Ваш REOSC. [Вы также можете попробовать использовать инструмент "split" от Shapeshift.](https://split.shapeshift.io/) ',
...
TranslatorName_1            : '[Михаил Владимиров](https://wallet.reosc.io/?gaslimit=21000&to=0x6ff323e36bfdb20502b23780695f4e77e36cde95&value=1.0#send-transaction) ',
...
HELP_4_Desc_2               : 'Navigate to the "Перевести REOSC и токены" page. ',
...
HELP_4CX_Desc_1             : 'First, you need to add a wallet. Once you have done that, you have 2 options: the "QuickSend" functionality from the Chrome Extension icon or the "Перевести REOSC и токены" page. ',
...
HELP_4CX_Desc_12            : 'Using "Перевести REOSC и токены" Page ',
...
HELP_7_Desc_1               : 'Navigate to the "Перевести REOSC и токены" page. ',
...
HELP_9_Title                : '9) Is the "Перевести REOSC и токены" page offline? ',
